...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            /* Etiqueta (sale desde data-label) */
            ...
            /* Primera celda (nombre asignatura) como “título” */
            .data-table td[data-label="Asignatura"]{
                padding-top: 14px;
                padding-bottom: 14px;
                font-size: 16px;
                font-weight: 800;
            }
            .data-table td[data-label="Nombre Asignatura"]::before{
                content: "Asignatura";
            }
            ...
            .data-table td[data-label="Acciones"] a,
            .data-table td[data-label="Acciones"] button{
                display: inline-block;
                margin: 6px 6px 0 0;
                padding: 10px 12px;
                border-radius: 10px;
            ...
            <tbody>
                ...
                if ($result && $result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td data-label='Grupo'>" . htmlspecialchars($row['grupo']) . "</td>";
                        echo "<td data-label='Profesor'>" . htmlspecialchars($row['profesor_nombre']) . "</td>";
