...
<head>
    ...
    <style>
        ...
        .data-table td[data-label="Número de Aula"]{
            padding-top: 14px;
            padding-bottom: 14px;
            font-size: 16px;
            font-weight: 800;
        }
        .data-table td[data-label="Número de Aula"]::before{
            content: "Aula";
        }
            ...
            <tbody>
                ...
                if ($result && $result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr>";
                        echo "<td data-label='Número de Aula'>" . htmlspecialchars($row['numero_aula']) . "</td>";
                        echo "<td data-label='Capacidad'>" . htmlspecialchars($row['capacidad']) . "</td>";
