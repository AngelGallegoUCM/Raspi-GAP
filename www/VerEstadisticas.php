...
<head>
    ...
    <style>
        ...
        /* Formulario de fechas en columna */
        form[method="GET"]{
        ...
        /* Tabla -> tarjetas (una métrica por bloque) */
        .stats-table{
            border: 0;
            margin: 12px 0;
        }
        ...
        if (isset($_GET['inicio']) && isset($_GET['fin'])) {
            ...
            if (!empty($errores)) {
                ...
                try {
                    ...
                    echo "<td data-label='Total de Asistencias'><div class='stat-number'>" . number_format($total_asistencias, 0, ',', '.') . "</div></td>";
                    echo "<td data-label='Días No Lectivos'><div class='stat-number'>" . number_format($total_nolectivos, 0, ',', '.') . "</div></td>";
                    echo "<td data-label='Incidencias Justificadas'><div class='stat-number'>" . number_format($total_justificadas, 0, ',', '.') . "</div></td>";
                    echo "<td data-label='Incidencias Sin Justificar'><div class='stat-number'>" . number_format($total_no_justificadas, 0, ',', '.') . "</div></td>";
                    echo "<td data-label='Total de Incidencias'><div class='stat-number'>" . number_format($total_incidencias, 0, ',', '.') . "</div></td>";
